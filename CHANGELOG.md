...
- Standardize PG/legacy database settings, port handling, and safe connection URL construction.
- Correct CMS input/output roots and add an explicit fixed-snapshot download option.
- Keep generated support outputs outside code and hospital-level analytic exports under an ignored restricted-data directory.
- Recover 17 missing view definitions plus `safe_to_numeric`; supply input column contracts and transactional dependency-ordered setup. Correct mixed-case view quoting.
...
Submitted package with updated manuscript title. Retained as the original cited snapshot.
