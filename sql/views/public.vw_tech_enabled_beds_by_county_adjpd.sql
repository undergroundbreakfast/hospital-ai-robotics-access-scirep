CREATE OR REPLACE VIEW public."vw_tech_enabled_beds_by_county_adjpd" AS
 ...
 SELECT cs.county_fips,
    round(cs.total_weighted_score::numeric / NULLIF(cs.total_adjpd, 0)::numeric, 5) AS weighted_avg_tech_score,
    cs.tech_enabled_adjpd,
    cs.total_adjpd,
    cs.tech_enabled_adjpd::numeric * 100.0 / NULLIF(cs.total_adjpd, 0)::numeric AS pct_tech_enabled_adjpd,
    m.deaths,
    m.population,
    m.crude_rate,
    h.irr_county_value
